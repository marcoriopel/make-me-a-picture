...
export class AuthController {
  ...
  private configureRouter(): void {
    ...
    this.router.post('/authenticate', (req, res) => {
      ...
      //   }
      this.authService.loginUser(req, res, (user: any) => {
        const token = this.tokenService.generateAccesToken(user.username);
    ...
    this.router.post('/register', (req, res) => {
      ...
      //   }
      this.authService.registerUser(req, res, (user: any) => {
        const token = this.tokenService.generateAccesToken(user.username);
          const avatar: number = user.avatar;
